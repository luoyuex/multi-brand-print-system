import os
os.chdir(r"D:/code/HBProject/multi-brand-print-system/backend")
...
renderer.html_to_pdf(html, r"D:/code/HBProject/multi-brand-print-system/backend/_gen.pdf", paper="241x140")
import pymupdf
d = pymupdf.open(r"D:/code/HBProject/multi-brand-print-system/backend/_gen.pdf")
