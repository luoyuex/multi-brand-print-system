...
_DEFAULTS = {
    ...
    "paper_size": "140x241", # 纸张尺寸代码：140x241（竖版渲染，打印时旋转90°）| A5 | A4
    "copies": 1,
    "sumatra_path": "",      # 空 = 自动探测
    "print_rotate": 90,      # 打印时对 PDF 的旋转角度：0 | 90 | 180 | 270
                             # 渲染成竖版 140x241（走纸方向内容不会溢出），送打印机前
                             # 旋转 90° → 241x140，走纸恒为 140mm，与原分页一致。
                             # 打出的纸按长边上下拿时内容正向可读。
}
