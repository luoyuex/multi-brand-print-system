...
_DEFAULTS = {
    ...
    "paper_size": "241x140", # 纸张尺寸代码：241x140（横版渲染，方向与一联纸一致）| A5 | A4
                             # 页面直接按一联（241宽×140高，走纸140）渲染，商品行沿走纸
                             # 方向向下延伸，超过一联自动分页到下一联，品类多时不受限。
    "copies": 1,
    "sumatra_path": "",      # 空 = 自动探测
    "print_rotate": 0,       # 打印时对 PDF 的旋转角度：0 | 90 | 180 | 270
                             # 页面方向已与纸张一致（241x140 横版），无需旋转；
                             # SumatraPDF 也不会再自动转向，打出即正向可读。
}
